...
//            exchange = @Exchange(value = RabbitConfig.EMAIL_EXCHANGE,type = ExchangeTypes.TOPIC),key = "email.topic.support")})
...
//                int i = 1 / 0;
//            }
//            JSONObject object = convertDataToMap(message);
//            Mail mail = BeanUtil.mapToBean(object, Mail.class);
//            mailUtil.send(mail);
//
//            //3.更新状态
